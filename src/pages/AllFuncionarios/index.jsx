...
function AllTraining({ itensPerPage, setItensPerPage }) {
  ...
  const FuncionarioData = useMemo(() => {
    ...
    computedFuncionarios = computedFuncionarios.filter(
      (value) => value.id !== 0,
    );
  ...
  }, [listaFuncionario, currentPage, search, itensPerPage]);
  ...
  const renderData = () => (
    <Row className={styles.rowMain}>
      {FuncionarioData.length === 0 ? (
        <span className={styles.spanNaoha}>Não há funcionário</span>
      ) : (
            ...
            >
              <div className={styles.containerIcons}>
                <div className={styles.icons}>
                  <AiTwotoneEdit
                    onClick={() => loadFuncionarioData(value.id)}
                  />
                </div>
                <div className={styles.icons}>
                  <AiFillDelete
                    onClick={() => deleteFuncionarioData(value.id)}
                  />
                </div>
                <div className={styles.icons}>
                  <IoListCircleOutline
                    onClick={() => readTreinamentoFunc(value.id)}
                  />
                </div>
              </div>
  ...
  return (
    <>
      ...
      <main className={styles.main}>
        <div className={styles.mainTop}>
          <div className="row" id={styles.mb2}>
            ...
            >
              <Button
                id={styles.buttonAgendarTreinamento}
                onClick={handleShow}
                variant="secondary"
                size="lg"
              >
        ...
        <div className={styles.containerButtonVerMais}>
          {totalItemsFuncionarios > 2 &&
          itensPerPage <= FuncionarioData.length &&
          !search ? (
            <button
              type="button"
      ...
      <ModalAgendamento
        setTotalItemsFuncionarios={setTotalItemsFuncionarios}
        show={show}
        setShow={setShow}
        setFuncionario={setFuncionario}
        funcionario={funcionario}
        totalItemsFuncionarios={totalItemsFuncionarios}
        loading={loading}
      ...
      />
      <ModalEditar
        statusEditFunc={statusEditFunc}
        showDois={showDois}
        onValueChange={onValueChange}
        editFuncionarioDetails={editFuncionarioDetails}
        loading={loading}
        handleCloseDois={handleCloseDois}
        funcionario={funcionario}
      />
      <ModalDelete
        statusDelFunc={statusDelFunc}
        showTres={showTres}
