    ...
    >
      ...
      <Modal.Footer className={styles.modalFooter}>
        ...
        <ButtonSalvar
          ...
          isDisabled={funcionarioId === 0 || treinamentoId === 0}
        />
      </Modal.Footer>
      {loading === true ? (
      ...
      {statusCreateAgend.status === 400 ? (
        <div className={styles.msgErroAgend}>
          Erro! Já há um treinamento para este funcionário ou dados são
          inválidos{" "}
        </div>
      ) : null}
    </Modal>
