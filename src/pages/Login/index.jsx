      ...
      <main className={styles.main}>
        ...
        <section className={styles.sectionForm}>
          ...
          {entrou && status === 400 ? (
            <div className={styles.msgErro}>
              Erro ao acessar. Verifique seus dados.
            </div>
          ) : null}
          <div className={cx(styles.containerFooterForm, "row")}>
            <div
              href="#teste"
              className={cx(
                styles.titleFooterForm,
                styles["text-centraliza"],
                "col-12 col-sm-6 text-centraliza",
              )}
            >
              Usuário novo?
            </div>
        ...
        <div className={styles.containerForgotPassword}>
          <a href="#teste" className={styles.forgotPassword}>
            <span className={`${styles.span} ${styles.forgotYourPassword}`}>
              Esqueceu sua senha?
            </span>
          </a>
        </div>
          ...
          <Row className={cx(styles.rowSalesforce)}>
            <Col>
              <li className={styles.navItem}>
                <a
                  className={`${styles.navLink} ${styles.navTextWhite}`}
                  href="https://frontend-official-training-sys-b2bc9aa79c23.herokuapp.com/"
                >
                  &copy; 2022
