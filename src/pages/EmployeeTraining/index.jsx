    ...
    return (
        <>
            ...
            <div className={styles.mb}>
                <Button variant="primary" size="lg" onClick={handleClick} className={styles.buttonVoltar}>
                    Voltar
                </Button>
            </div>
            <main>
                ...
                <Container className={cx(styles.container2, "table-responsive")}>
                    ...
                    { totalTreinamentos.length === 0 ? <div className={styles.spanTrein}>Não há treinamento</div> : null }
                </Container>
            </main>
        </>
    )
