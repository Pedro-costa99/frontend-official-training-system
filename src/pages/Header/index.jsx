    ...
    return (
        <header>
            <Nav defaultActiveKey="/home" as="ul" className={cx(styles.nav, 'row')}>
                ...
                <Nav.Item as="li" className={cx(styles.navItemRight, 'col-12 col-sm-6')}>
                {statusHeader.status === 400 ? '' : <h1>Olá, {usuario.user.name}</h1>}
                    <Dropdown id="dropdown">
                        <Dropdown.Toggle id="dropdown-basic" className={styles.dropdownBasic}>
                            <FaUserCircle />
                        </Dropdown.Toggle>
                        <Dropdown.Menu id="dropdown-menu" className={styles.dropdownMenu}>
                            <Dropdown.Item className={styles.navLinkSair}>Configurações</Dropdown.Item>
                            <Dropdown.Item className={styles.navLinkSair} onClick={handleLogout}>Sair</Dropdown.Item>                            
                        </Dropdown.Menu>
                    </Dropdown>
                </Nav.Item>
            </Nav>
                ...
                <Container>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className={styles.meAuto}>
                            <Link className={styles.navLink} to="/treinamentos">Treinamentos</Link>
                            <Link className={styles.navLink} to="/funcionarios">Funcionários</Link>
                        </Nav>
                    </Navbar.Collapse>
                </Container>
            </Navbar>
